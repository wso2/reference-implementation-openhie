    ...
    resource.name = [
      {
        ...
        given: form.givenNames ? form.givenNames.split(',').map((s) => s.trim()).filter(Boolean) : undefined,
      },
    ];
  }
...
export default function PatientFormModal({ open, mode, patient, onClose, onSuccess }) {
