...
function formFromPatient(patient: FhirPatient | null): FormState {
  if (!patient) return {} as FormState;
...
function buildFhirPatient(form: FormState, existingPatient: FhirPatient): FhirPatient {
  const resource: FhirPatient = { ...existingPatient, active: existingPatient.active ?? true };
...
export default function PatientInlineEditForm({
  patient,
  onSuccess,
  onCancel,
  onView,
