          ...
          <CardContent sx={{ p: 3 }}>
            ...
            <Box sx={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 2.5 }}>
              ...
              <Box>
                ...
                <Typography variant="body2" sx={{ mt: 0.25, textTransform: 'capitalize' }}>
                  {user?.role || '—'}
                </Typography>
              </Box>
                ...
                <FormControlLabel
                  control={
                    <Switch
                      ...
                      onChange={(e) =>
                        handlePreferenceChange('auditAutoRefresh', e.target.checked)
                      }
                    />
                  }
                ...
                {preferences.auditAutoRefresh && (
                  <FormControl size="small" sx={{ minWidth: 220 }}>
                    ...
                    <Select
                      ...
                      onChange={(e) =>
                        handlePreferenceChange('auditRefreshInterval', e.target.value)
                      }
                    >
