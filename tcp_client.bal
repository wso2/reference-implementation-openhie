...
PID|1||123456^^^Hospital^MR||Doe^John^A||1980-01-01|M|||123 Main St^^Anytown^CA^12345|555-555-5555|||M
...
PV1|1|I|W^389^1^UCLA|3|||1111^Jones^John^A^^Dr.||2222^Smith^Jane^B^^Dr.||SUR||||ADM|A0|`;
    ...
    // Define the ADT^A08 message (Patient Update)
    string message_a08 = string `MSH|^~\\&|SendingApp|SendingFac|ReceivingApp|ReceivingFac|20241013130000||ADT^A08|54321|P|2.3
EVN|A08|20241013130000
PID|1||123456^^^Hospital^MR||Doe^John^A||1980-01-01|M|||789 Updated St^^Newtown^CA^54321|555-777-8888|||M
NK1|1|Doe^Jane|SPO|789 Secondary St^^Newtown^CA^54321|555-999-0000
PV1|1|I|W^389^1^UCLA|3|||1111^Jones^John^A^^Dr.||2222^Smith^Jane^B^^Dr.||SUR||||ADM|A0|`;

    // Define the QBP^Q23 message (Patient Query)
    string message_q23 = string `MSH|^~\\&|SendingApp|SendingFac|ReceivingApp|ReceivingFac|20241013140000||QBP^Q23|67890|P|2.3
QPD|IHE PIX Query|Q123456|123456^^^Hospital^MR|Doe^John^A|1980-01-01|M
RCP|I`;
    ...
    // log:printInfo("Sending ADT^A08 (Patient Update)...");
    // check sendMessageAndReceiveResponse(tcpClient, message_a08);
